    ...
    async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            await NotificationModel.create({
                ...
                message: `${req.user?.name} has asked a question in ${content.title}`,
                userId: req.user?._id,
            });
        ...
        try {
            ...
            if (req.user?._id === question.user._id) {
                ...
                await NotificationModel.create({
                    ...
                    message: `${req.user?.name} has answered your question in ${content.title}`,
    ...
    async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            const notification = {
                ...
                message: `${req.user?.name} jas given review in ${course?.name}`,
            };
