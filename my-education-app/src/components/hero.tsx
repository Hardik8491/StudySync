...
const HeroBanner = () => {
  ...
  return (
    <section className="relative flex  w-full items-center justify-center bg-gradient-to-r from-slate-900/10 to-stone-800/50">
      <div className="container mx-auto flex flex-col-reverse items-center justify-between gap-8 px-4 md:flex-row">
        {/* Text Content */}
        <div className="relative flex flex-col items-start justify-center space-y-6 text-white">
        ...
        <div className="relative w-full md:max-w-md max-w-lg  md:mt-0">
          ...
          <div className="absolute hidden inset-0 lg:flex xl:h-10 xl:w-10 h-8 w-8 hero_animation rounded-full bg-white/20 opacity-50 shadow-sm" />
          <div className="absolute inset-0 lg:flex lg:h-[48vh] lg:w-[48vh] h-[40vh] w-[40vh] top-32 ml-12 lg:ml-10 lg:top-[100px] hero_animation rounded-full bg-white/20 opacity-50 shadow-sm circle-medium" />
          ...
          />
          <div className="absolute hidden lg:flex xl:ml-[400px] top-[400px] ml-[320px] inset-0 xl:h-10 xl:w-10 h-8 w-8 hero_animation rounded-full bg-white/20 opacity-50 shadow-sm" />
        </div>
      </div>
    </section>
  );
