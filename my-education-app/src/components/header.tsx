    ...
    return (
        <div className='w-full relative border'>
            <div
                className={`${
                    active
                        ? "dark:bg-opacity-50   dark:bg-gradient-to-b dark:from-gray-900 dark:to-black fixed top-0 left-0 z-[80] dark:border-[#ffffff1c] border-b w-full "
                    ...
                    <div className='w-full h-[80px] flex items-center justify-between px-3'>
                        ...
                        <div className='flex items-center space-x-4'>
                            ...
                            {user ? (
                                ...
                                <div className='default-btn hidden md:flex flex-1 '>
                                    Register Now
                                </div>
                            )}
