        ...
        <form onClick={handleSubmit}>
          <div className="800px:w-[50%] m-auto block pb-4">
            ...
            <div className="w-[100%] pt-2">
              <label className="block pb-2" htmlFor="Email Address">
                Email Address
              </label>
              <input
                type="text"
            ...
            <input
              ...
              className={`w-full 800px:W-[250px] h-[50px] border border-[#37a39a] dark:text-[#fff] text-black rounded-[3px] `}
            />
          </div>
        </form>
        <br />
